...
export default function Hero() {
  return (
    <section
      className="bg-white flex flex-col h-screen rounded-4xl md:flex-row items-center justify-between p-8 rounded-b-[0rem] bg-gradient-to-br from-[#F8BBD0] to-[#FFF8F9] bg-[url('/img/mannequins/img_2.png')] bg-cover bg-center"
    >
      <div className="max-w-2xl pl-10 p-6 space-y-6">
        <motion.h1
          ...
          className="text-5xl font-bold text-white md:text-[#333333]"
        >
        ...
        <motion.p
          ...
          className="text-white md:text-[#6B4E57] text-lg font-medium"
        >

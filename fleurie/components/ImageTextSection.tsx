                  ...
                  <section className="mt-7 max-w-7xl w-[90%] px-6 mx-auto py-10 space-y-16">
                    ...
                    <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-10">
                      ...
                      <div className="flex justify-center">
                        <Image
                          src="/img/mannequins/img_MeSeesou.png"
                        ...
                        <span
                          className="
                            block w-[20%] h-[(0%] bg-[#FFF8F9] shadow-lg absolute top-0 left-5
                      ...
                      {/* Texte */}
                      <div className="z-10 bg-[#FFF8F9] p-6 rounded-lg shadow-soft max-w-2xl flex-1">
                        <h4 className="text-3xl text-[#333333] font-extrabold mb-4 tracking-wide drop-shadow">
                          FORMATION ET VISITE MÉDICALE
                        </h4>
                        <p className="mb-4 text-xl text-[#6B4E57] transition-all duration-300 hover:text-[#E91E63]">
                        ...
                        <p className="text-xl text-[#6B4E57] transition-all duration-300 hover:text-[#E91E63]">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-10 group transition-all duration-700">
                      ...
                      <div className="flex justify-center relative">
                        <div className="absolute -inset-2 bg-[#FFF8F9] rounded-[48px] blur-lg opacity-60 group-hover:scale-105 group-hover:opacity-80 transition-all duration-700"></div>
                        <Image
                          src="/img/Analyse.png"
                          alt="Description de l'image"
                          width={400}
                      ...
                      {/* Texte */}
                      <div className="bg-[#FFF8F9] p-6 rounded-lg shadow-soft flex-1 max-w-2xl z-10">
                        <h4 className="text-3xl text-[#333333] font-extrabold mb-4 tracking-wide drop-shadow">
                          <span className="inline-block">ANALYSE DU MARCHÉ LOCAL</span>
                        </h4>
                        <ul className="list-disc text-xl pl-7 space-y-4 text-[#6B4E57]">
                          <li className="transition-all duration-300  hover:text-[#E91E63]">
                      ...
                      <span
                        className="
                          block w-[90%] h-[38%] bg-[#FFF8F9] shadow-lg absolute bottom-0 right-5
